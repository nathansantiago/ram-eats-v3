...
async def recommendation_recommend_meal(input: RecommendationRecommendMealInput, request: Request) -> RecommendationRecommendMealOutput:
    ...
    simply_prepared_station_id = meal_calculation_module.get_station_id("Simply Prepared Grill")
    kitchen_table_station_id = meal_calculation_module.get_station_id("Kitchen Table")
